      ...
      <div class="blog-main">
         ...
         <div class="blog-body">
            ...
            <section id="definitions">
               ...
               <p class="caption">
                  Visually, the graphs show that all points <i>n</i> beyond <vm :formula='`$n_0$`'></vm> adhere to the rules of their respective set.
               ...
               <p>
                  <ul>
                     <li>
                        (a) <vm :formula='this.latex.bigO'></vm> means <vm :formula='`$c \\cdot g(n)$`'></vm> is an <i>upper bound</i> on <vm :formula='`$f(n)$`'></vm>. Thus there exists
                     ...
                     <li>
                        (b) <vm :formula='this.latex.bigOmega'></vm> means <vm :formula='`$c \\cdot g(n)$`'></vm> is a <i>lower bound</i> on <vm :formula='`$f(n)$`'></vm>. Thus there exists
                     ...
                     <li>
                        (c) <vm :formula='this.latex.bigTheta'></vm> means <vm :formula='`$c_1 \\cdot g(n)$`'></vm> is an <i>upper bound</i> on <vm :formula='`$f(n)$`'></vm> and
                  ...
                  <vm class="math" :formula='`$$\\lim_{n\\to\\infty}f(n) \\leq c \\cdot g(n), \\mathrm{\\;when\\;}n > n_0$$`'></vm>  
               <p>
               ...
               <ul>
                  <li>
                     1) Some people consider <vm :formula='this.latex.bigO'></vm> to be an <a href="https://en.wikipedia.org/wiki/Big_O_notation#Equals_sign" target="_blank">abuse of notation</a> because we mean to say
                     "<i>f(n)</i> is a member of set <i>O(g(n))</i>" which usually is represented in set notation as <vm :formula='`$f(x) \\in O(g(n))$`'></vm>.
                  </li>
                  <li>
