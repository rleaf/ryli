         ...
         <div class="blog-body">
            ...
            <section id="entropy">
               ...
               <section id="entropymath">
                  ...
                  <div class="math-b">
                     <vm class="math" :formula='this.latex.entropy'></vm>
                  </div>
                  <p>
                  ...
                  <div class="math-b">
                     <vm class="math" :formula='this.latex.uniform'></vm>
                  </div>
               </section>
               ...
               <section id="entropyexamples">
                  ...
                  <div class="math-t">
                     <vm class="math" :formula="`$$\\mathbb{H}(X),\\; X \\sim \\mathcal{U}(1, 3)$$`"></vm>
                     <br>
                     <vm class="math" :formula='this.latex.uniformThree'></vm>
                  </div>
                  <div class="math-t">
                     <i>A fair Bernoulli distribution</i>
                     <vm class="math" :formula="`$$\\mathbb{H}(X),\\; X \\sim \\mathcal{U}(1, 2)$$`"></vm>
                     <br>
                     <vm class="math" :formula='this.latex.uniformBernoulli'></vm>
                  </div>
                  <div class="math-t">
                     <vm class="math" :formula="`$$\\mathbb{H}(X),\\; X \\sim p\\;\\text{where}$$`"></vm>
                     <br>
                     <vm class="math" :formula='`$$p(x) = \\begin{cases} 
                                                               ...
                                                               \\end{cases} $$`'></vm>
                     <br>
                     <vm class="math" :formula='this.latex.unfairBernoulli'></vm>
                  </div>
                  <div class="math-bt">
                     <vm class="math" :formula="`$$\\mathbb{H}(X),\\; X \\sim p\\;\\text{where}$$`"></vm>
                     <br>
                     <vm class="math" :formula='`$$p(x) = \\begin{cases} 
                                                               ...
                                                               \\end{cases} $$`'></vm>
                     <br>
                     <vm class="math" :formula='this.latex.extremeBernoulli'></vm>
                  </div>
                  <p>
            ...
            <section id="selfinformation">
               ...
               <vm class="math" :formula="`$I(x) \\triangleq -\\log_bp(x)$`"></vm>
               <p>
            ...
            <section id="cross">
               ...
               <div class="math-bt">
                  <vm class="math" :formula='this.latex.crossEntropy'></vm>
               </div>
               <p>
               ...
               <section id="crossexample">
                  ...
                  <div class="math-bt">
                     <vm class="math" :formula='this.latex.crossEntropyExample1'></vm>
                     <vm class="math" :formula='this.latex.crossEntropyExample2'></vm>
                  </div>
                  <p>
            ...
            <section id="joint">
               ...
               <vm class="math" :formula='this.latex.jointEntropy'></vm>
               <p>
               ...
               <section id="jointexample">
                  ...
                  <div class="math-t">
                     <vm class="math" :formula='this.latex.jointEntropy2'></vm>
                  </div>
               </section>
            </section>
            ...
            <section id="conditional">
               ...
               <div class="math-bt">
                  <vm class="math" :formula='this.latex.conditionalEntropy1'></vm>
               </div>
               <p>
               ...
               <section id="61">
                  ...
                  <div class="math-t">
                     <vm class="math" :formula='this.latex.conditionalEntropy2'></vm>
                  </div>
               </section>
               ...
               <section id="645">
                  ...
                  <div class="math-t">
                     <vm class="math" :formula='this.latex.conditionalEntropy3'></vm>
                  </div>
               </section>
               ...
               <section id="70">
                  ...
                  <div class="math-t">
                     <vm class="math" :formula='this.latex.conditionalEntropy4'></vm>
                  </div>
               </section>
